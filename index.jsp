  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="http://s3.amazonaws.com/digitaltrends-uploads-prod/2015/07/Save-200-on-a-MacBook-Air-Now-Apple-Deals-2.png" alt="book" width="450 pixel" height="400 pixel">
      </div>

      <div class="item">
        <img src="https://cms-images.idgesg.net/images/article/2016/04/hp-spectre-13.3_right-facing-paired-with-wireless-mouse-100654245-orig.jpg" alt="book" width="450 pixel" height="400 pixel">
      </div>
    
      <div class="item">
        <img src="http://cdn.wallpapersafari.com/15/33/23idzH.jpg" alt="book" width="450 pixel" height="400 pixel">
      </div>

      <div class="item">
        <img src="http://www.wallpapersxl.com/wallpapers/1366x768/notebook/134004/notebook-samsung-x-series-pc-with-resolution-134004.jpg" alt="book" width="450 pixel" height="400 pixel">
      </div>
    </div>
...
<center><h3>The World of Laptop.</h3> 
<p>For the best Laptops in the City visit our site.</p></center>
<!-- Wrap the rest of the page in another container to center all the content. -->
    ...
    <div class="container marketing">
      ...
      <div class="w">
        <div class="col-lg-4">
          <img class="img-circle" src="https://s-media-cache-ak0.pinimg.com/736x/d5/fd/12/d5fd129e27ba314839e80bfd974b048d.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>New arrivals</h2>
          <p>In this you can check out the New arrivals of Laptops</p>
      <!--     <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p> -->
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="http://i0.wallpaperscraft.com/image/laptop_light_computer_54776_300x188.jpg" alt="Generic placeholder image" width="140" 

height="140">
          <h2>On Discount</h2>
          <p>In this category you can find models on discount</p>
        <!--   <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p> -->
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          ...
          <h2>Gaming</h2>
          <p>In this category you can find Gaming Laptops</p>
         <!--  <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p> -->
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
      ...
      <div class="rowe">
        <div class="col-md-7">
          <h2 class="featurette-heading">Laptops <span class="text-muted">It'll blow your mind.</span></h2>
